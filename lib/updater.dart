...
class Updater extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform platform;

  Updater({Key key, this.platform}) : super(key: key);

  @override
  _UpdaterState createState() => new _UpdaterState();
}
